            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="index.php?page=app_createpayment&sy_id=<?php echo $_GET['sy_id']?>&stud_id=<?php echo $_GET['stud_id']?>" class="btn btn-primary btn-sm" style="float:right;"><i class="fa fa-plus"></i> Create Payment</a>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        ...
                        <table class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th style="font-size: 12px;">Amount</th>
                                    <th style="font-size: 12px;">Change</th>
                                </tr>
                            </thead>
                            <tbody>
                            <?php
                                ...
                                $select_query->execute();
                                while($row_sel =$select_query->fetch()){
                                    $change = $row_sel['cash'] - $row_sel['amount'];
                                    echo'<tr>';
                                        echo'<td>'.date("F j, Y", strtotime($row_sel['date'])).'</td>'; 
                                        echo'<td>'.$row_sel['or_no'].'</td>'; 
                                        echo'<td>Php '.number_format($row_sel['cash'], 2, '.', ',').'</td>';
                                        echo'<td>Php '.number_format($row_sel['amount'], 2, '.', ',').'</td>';
                                        echo'<td>Php '.number_format($change, 2, '.', ',').'</td>';
                                    echo'</tr>';
                            ...
                            <tfoot>
                                <tr>
                                    <td colspan="3"><label style="float:right;">Total Payment :</label></td>
