                            ...
                            <?php
                                ...
                                while($row_sel =$select_query->fetch()){
                                    ...
                                    echo'<tr>';
                                        ...
                                        echo'<td><a href="index.php?page=app_viewpayments&sy_id='.$row_sel['sy_id'].'&stud_id='.$_GET['stud_id'].'" class="btn btn-primary btn-sm"><i class="fa fa-search"></i> View Payment</a></td>';
                                    echo'</tr>';
