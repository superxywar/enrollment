            ...
            <!-- general form elements -->
                <div class="card card-primary">
                            ...
                            <?php
                                ...
                                while($su_row=$su_sele->fetch()){
                                    ...
                                    echo'<tr>';
                                        ...
                                        echo'<td><a href="index.php?page=app_classlist&sched_id='.$su_row['sched_id'].'" class="btn btn-primary"><i class="fas fa-search"></i> View Class List</a></td>';
                                    echo'</tr>';
                            }
                            ?>
                            </tbody>
                    ...
                    <div class="col-12" style="padding:20px;" >
                        <a href="print.php?page=print_schedule&sy_id=<?php echo $t_row['sy_id']?>"class="btn btn-info" style="float:right;"><i class="fas fa-print"></i> Print Report </a>
                    </div>
                </div>
            </div>
            <!-- /.col -->
